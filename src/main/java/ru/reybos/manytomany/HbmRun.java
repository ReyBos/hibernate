...
import ru.reybos.manytomany.model.Address;
import ru.reybos.manytomany.model.Person;
...
public class HbmRun {
    public static void main(String[] args) {
        ...
        try {
            ...
            Person person = session.get(Person.class, one.getId());
